...
model = Sequential()
model.add(Dense(200, activation="tanh", kernel_initializer="uniform", input_dim=maxlen*50))
...
model.compile(optimizer=Adam(lr=0.01),loss='kullback_leibler_divergence',metrics=['accuracy'])
